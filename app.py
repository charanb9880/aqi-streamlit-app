...
from scipy.ndimage import gaussian\_filter1d

st.set\_page\_config(page\_title="🌍 AQI Dashboard", layout="wide")
...
# 🌐 Pollutant extent map

st.subheader("🗺️ Live AQI Map by Pollutant (with Layer Control)")
m = folium.Map(location=\[lat, lon], zoom\_start=6)
...
try:
url = "[https://api.openaq.org/v2/latest](https://api.openaq.org/v2/latest)"
params = {
...
"what is pm10": "PM10 includes particles up to 10 microns in size, such as dust, pollen, and mold. It affects the lungs and respiratory system.",
"what is no2": "NO2 (Nitrogen Dioxide) is a reddish-brown toxic gas primarily released by vehicles and industrial activity.",
"what is o3": "O3 (Ozone) at ground level is a harmful air pollutant and a major component of smog.",
"what is co": "CO (Carbon Monoxide) is a colorless, odorless gas produced by incomplete combustion. High levels are dangerous to health.",
"what is so2": "SO2 (Sulfur Dioxide) is released from burning fossil fuels and can cause respiratory problems and acid rain.",
"how can i reduce air pollution": "You can reduce pollution by using public transport, conserving energy, avoiding open burning, and supporting clean energy.",
"is aqi above 100 safe": "AQI above 100 is considered unhealthy for sensitive groups like children, elderly, or those with respiratory conditions.",
"what is the safest aqi range": "AQI between 0 and 50 is considered safe and poses little or no risk to health.",
"how often is aqi updated": "AQI data from reliable sources like OpenAQ is updated every 1-2 hours, depending on the station.",
"why is my area polluted": "Local air pollution depends on traffic, industry, weather conditions, and topography. You can check sources near you on the map.",
"can i exercise when aqi is high": "It is not recommended to exercise outdoors when AQI is above 150. For sensitive individuals, even 100+ AQI may be risky."
}
